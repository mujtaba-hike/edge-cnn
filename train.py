...
class ModelTrainer(object):
    ...
    def train(self):
        ...
        for iter in range(self.global_step + 1, tt.arg.train_iteration + 1):
            ...
            full_edge_loss_layers_intra = [self.edge_loss((1-full_logit_layer[:, 0]), (1-full_edge[:, 0])) for full_logit_layer in full_logit_layers]
            full_edge_loss_layers_inter = [self.edge_loss((1-full_logit_layer[:, 1]), (1-full_edge[:, 1])) for full_logit_layer in full_logit_layers]
            full_edge_loss_layers = [.5 * (full_edge_loss_layers_inter[ii] + full_edge_loss_layers_intra[ii]) for ii in range(len(full_edge_loss_layers_intra))]
...
if __name__ == '__main__':
    ...
    tt.arg.dataset_root = '/mnt/mujtaba/fewshot-egnn/egnn_cvpr2019'
    ...
    tt.arg.num_gpus = 4 if tt.arg.num_gpus is None else tt.arg.num_gpus
